...
public class RsaUtil {
    ...
    private static final String ALGORITHMS1 = "RSA/None/PKCS1Padding";
    private static final String ALGORITHMS2 = "RSA/None/Nopadding";
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
        ...
        byte[] keyBytes = decode.decodeBuffer(privateKey);
    ...
    public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey) throws Exception {
        //base64格式的key字符串转Key对象
    	BASE64Decoder decode=new BASE64Decoder();
        byte[] keyBytes = decode.decodeBuffer(publicKey);
    ...
    public static String getPrivateKey() {
        ...
        return encode.encode(key.getEncoded());
    }
